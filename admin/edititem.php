...
<html lang="en">
  ...
  <head>
    ...
    <title>Shop Admin Homepage</title>
    ...
    <div class="container">
      ...
      <div class="row">
		...
		?>
         ...
         <h3 style="color:#3366CC;">UPDATE FOOD ITEM</h3>
		 <?php
		 if(isset($_GET["msg"]))
		 {
		 ...
		 ?>
			...
			<TR>
				...
				<INPUT TYPE="file" NAME="product_image" accept="image/jpeg" id="product_image" class="form-control"></TD>
			</TR>
			<TR>
				<TD>Active Status</TD>
