  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		...
		<TABLE width="900px">
		<tr>
		<td colspan="6" align="right"><a href="../dldbill/orderbill/admingeneratebill.php?customer_code=<?php echo $_GET["customer_code"];?>&order_code=<?php echo $_GET["order_code"];?>&order_date=<?php echo $_GET["order_date"];?>" class="btn btn-sm btn-success" target="_blank">Print</a></td>
		</tr>
		</TABLE>
        </div>
        <!-- /.col-lg-9 -->
